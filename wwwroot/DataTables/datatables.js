 ...
 *   https://datatables.net/download/#dt/dt-1.13.8/b-2.4.2/date-1.5.1/sp-2.2.0/sl-1.7.0
 *
 * Included libraries:
 *   DataTables 1.13.8, Buttons 2.4.2, DateTime 1.5.1, SearchPanes 2.2.0, Select 1.7.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.8/b-2.4.2/date-1.5.1/sp-2.2.0/sl-1.7.0",
